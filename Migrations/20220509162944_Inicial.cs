    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LivrosLeitores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LivrosLeitores_AspNetUsers_IdLeitor",
                        column: x => x.IdLeitor,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LivrosLeitores_Livros_IdLivro",
                        column: x => x.IdLivro,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LivrosLeitores_IdLeitor",
                table: "LivrosLeitores",
                column: "IdLeitor");

            migrationBuilder.CreateIndex(
                name: "IX_LivrosLeitores_IdLivro",
                table: "LivrosLeitores",
                column: "IdLivro");
        }
